...
export default function APIDocumentation() {
  ...
  const parameters = [
    { name: "logo", desc: t("URL of your logo"), default: "null" },
    { name: "from", desc: t("Your organization billing address and contact info"), default: "null" },
    { name: "to", desc: t("Entity being billed – multiple lines ok"), default: "null" },
    { name: "ship_to", desc: t("Shipping address – multiple lines ok"), default: "null" },
    { name: "number", desc: t("Invoice number"), default: "null" },
    { name: "currency", desc: t("ISO 4217 3-digit currency code"), default: "USD" },
    { name: "custom_fields", desc: t("Array of objects – see Custom Fields below"), default: "[]" },
    { name: "date", desc: t("Invoice date"), default: t("current date") },
    { name: "payment_terms", desc: t("Payment terms summary (i.e. NET 30)"), default: "null" },
    { name: "due_date", desc: t("Invoice due date"), default: "null" },
    { name: "items", desc: t("Array of objects – see Line Items below"), default: "[]" },
    { name: "fields", desc: t('Object – see Subtotal Lines below'), default: `{"tax":"%","discounts":false,"shipping":false}` },
    { name: "discounts", desc: t("Subtotal discounts – numbers only"), default: "0" },
    { name: "tax", desc: t("Tax – numbers only"), default: "0" },
    { name: "shipping", desc: t("Shipping – numbers only"), default: "0" },
    { name: "amount_paid", desc: t("Amount paid – numbers only"), default: "0" },
    { name: "notes", desc: t("Notes – any extra information not included elsewhere"), default: "null" },
    { name: "terms", desc: t("Terms and conditions – all the details"), default: "null" },
  ];
